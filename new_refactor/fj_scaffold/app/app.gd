...
const CONNECTION_SCREEN_PATH := "res://new_refactor/fj_scaffold/app/connection_screen.tscn"
const BOARD_SCENE_PATH := "res://new_refactor/fj_scaffold/board/scenes/board.tscn"
